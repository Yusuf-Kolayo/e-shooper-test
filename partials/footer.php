    ...
    <div class="container-fluid bg-secondary text-dark mt-5 pt-5">
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>suite 25-27 Alen Avenue Ikeja Lagos. Nigeria</p>
                <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>info@e-shopper.com</p>
